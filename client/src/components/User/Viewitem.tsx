...
function Viewitem() {
  ...
  const handleQuantityChange = (index, newQuantity) => {
    const updatedItems = wishlistItems.map((item, idx) => {
      if (idx === index) {
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                <button
  onClick={() =>
    handleQuantityChange(idx, Math.max(1, wishlistItems[idx].quantity - 1))
  }
...
<button
  onClick={() =>
    handleQuantityChange(idx, wishlistItems[idx].quantity + 1)
  }
  className="px-3 py-1 text-gray-700 bg-gray-200 hover:bg-gray-300"
>
  +
